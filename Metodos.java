public class Metodos {
    ...
    public void nom_Erick(){
        System.out.println("==========================");
        est.setNombre("Erick");
        est.setApellido("Santillan");
        est.setEdad(21);
        est.setCodi("10");
        est.setUsuario("ErickStalin");
        System.out.println("Nombre: "+est.getNombre());
        System.out.println("Apellido: "+est.getApellido());
        System.out.println("Edad: "+est.getEdad());
        System.out.println("Codigo Unico: "+est.getCodi());
    ...
    public void nom_Guanoluisa(){
        System.out.println("==========================");
        est.setNombre("Elvis");
        est.setApellido("Guanoluisa");
        est.setEdad(23);
        est.setCodi("18");
        est.setUsuario("elvissoide");
        System.out.println("Nombre: " + est.getNombre());
        System.out.println("Apellido: " + est.getApellido());
        System.out.println("Edad: " + est.getEdad());
        System.out.println("Codigo Unico: " + est.getCodi());
